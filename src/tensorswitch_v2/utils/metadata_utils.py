...
# ============================================================================
# OMERO Metadata Builder (ported from bioformats2raw)
# ============================================================================
...
class ChannelInfo:
    ...
    color: Optional[str] = None  # hex RGB ("FF0000") or int ARGB
...
def extract_channels_from_ome_xml(ome_xml: str) -> Optional[List[ChannelInfo]]:
    ...
    ExcitationWavelength, and Fluor attributes. Unlike extract_omero_channels,
    this does NOT skip channels missing Name or Color — the builder's fallback
    cascades handle missing fields.
...
def extract_channels_from_czi_xml(czi_xml: str) -> Optional[List[ChannelInfo]]:
    ...
    Each Channel element may have attributes @Name, @Color (ARGB int),
    and child elements <EmissionWavelength>, <ExcitationWavelength>,
    <DyeName>, <Fluor>.
